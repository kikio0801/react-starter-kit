    ...
    <div className="mx-auto w-full max-w-md space-y-6 px-4 py-8 md:max-w-none md:p-0">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card className="animate-fade-in-delay-1">
          <CardHeader>
            <CardTitle className="text-lg">🧱 견고한 아키텍처</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="animate-fade-in-delay-2">
          <CardHeader>
            <CardTitle className="text-lg">⚡ 초고속 빌드 엔진</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="animate-fade-in-delay-3 md:col-span-2 lg:col-span-1">
          <CardHeader>
            <CardTitle className="text-lg">🛡️ 강력한 가드레일</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-sm leading-relaxed">
